...
mkdir client  # React app will live here later
PORT=4000
...
KIMI_KEY=xxxxxxxx   # get from https://kimi.moonshot.cn (session token)
...
app.listen(process.env.PORT, () => console.log(`Parliament on :${process.env.PORT}`));
npx nodemon server.js
curl -X POST localhost:4000/parliament \
  -H "Content-Type: application/json" \
  -d '{"question":"Is quantum tunnelling the same as quantum teleportation?"}'
